...
\section{Pairplot for the EMG parameters of the JGP dataset (section 5.2)}
...
\section{Fits for ID$_e$ models as function of ID, W and D for the JGP dataset (section 5.4)}
\begin{table}
...
\section{Pairplot for the EMG parameters for the GOP dataset (section 6.3)}
...
\section{Violinplot for the Galambos Copula, GO dataset (section 6.4)}
\begin{figure}[htbp]
    \centering
...
\section{$\rho$ values for the Gaussian copula (Section 6.4)}
\begin{table}[htbp]
	\centering
...
\section{Parameters of the t-copula, GO dataset (section 6.4)}
\begin{figure}[htbp]
    \centering
...
\section{Parameter values for the Gaussian copula for the YORMK dataset (section 7.6) for different D and W values}
...
\section{Parameter values for the t-copula for the YKORM dataset (section 7.6) for different strategies}
\begin{figure}[htbp]
	\centering
...
\section{Parameter values for the Galambos copula (Section 8.4.3)}
\begin{figure}[htbp]
	\centering
...
\section{Participant internal consistency concerning strategies (section 12)}
...
\section{Number of successful fits for the copula fits per (D,W) pair (Section C.2)}
