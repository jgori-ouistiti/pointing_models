...
gen_block_t = function(rho1, df, id_params, mt_params, block_levels, ntrials, seed){
  set.seed(seed)
  print('Entering gen_block_t R function')
...
# rho1 = .75
# df = 3.75
# id_params = list('distribution' = 'norm', 'params' = list(mean = 1, sd = 1))
# mt_params = list('distribution' = 'emg', 'params' = list(mu=1, sigma=1, lambda=1))
# block_levels = c(1,2,3,4,5,6,7,8)/9
# block_levels = runif(8)
# ntrials =20
# seed = 123
