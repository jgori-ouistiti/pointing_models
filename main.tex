...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=.8\textwidth]{img/fittslaw_guiard.pdf}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=.7\columnwidth]{img/fitts_ide_go_with_ellipse.pdf}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=.8\textwidth]{img/id_ide_yamanaka.pdf}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=.8\textwidth]{img/violin_yamanaka_pooled_dw.pdf}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=.8\textwidth]{img/R_yamanaka_DW.pdf}
