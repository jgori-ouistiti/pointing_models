...
from eval_data import eval_data_mean_mvgauss_df
...
if __name__ == "__main__":
    ...
    handles1_cop, handles2_cop = eval_data_mean_mvgauss_df(df_cop)
    handles2_cop[0].suptitle("t-Copula (Model 1)")
    ...
    handles1_emg, handles2_emg = eval_data_mean_mvgauss_df(df_emg)
    handles2_emg[0].suptitle("EMG (Model 2)")
    ...
    handles1_emg_control, handles2_emg_control = eval_data_mean_mvgauss_df(
        df_emg_control
    )
    handles2_emg_control[0].suptitle("EMG control (Model 3)")
    plt.ion()
    plt.show()
